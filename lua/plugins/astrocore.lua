  ...
  opts = {
    ...
    options = {
      ...
      g = { -- vim.g.<key>
        ...
        python3_host_prog = vim.fn.expand "~/.virtualenvs/neovim/bin/python3", -- point neovim to molten venv
        molten_image_provider = "image.nvim", -- set the image provider for Molten
      },
    },
